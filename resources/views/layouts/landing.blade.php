...
<body class="bg-paper font-sans text-ink antialiased selection:bg-brand-600 selection:text-white">
    <header class="sticky top-0 z-50 border-b border-outline-variant/40 bg-paper/90 backdrop-blur-md">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:h-20 sm:px-8 lg:px-12">
            <a href="{{ route('home') }}" class="group flex items-center gap-3">
                ...
                <span class="flex items-center gap-2">
                    <span class="font-display text-2xl font-black tracking-tight text-ink">Tem<span class="text-brand-600">Ji</span></span>
            ...
            <nav class="hidden items-center gap-8 lg:gap-10 md:flex">
                <a class="text-[15px] font-semibold text-on-surface-variant transition-colors hover:text-brand-600" href="#cara-kerja">Cara kerja</a>
                <a class="text-[15px] font-semibold text-on-surface-variant transition-colors hover:text-brand-600" href="#kategori">Kategori</a>
                <a class="text-[15px] font-semibold text-on-surface-variant transition-colors hover:text-brand-600" href="#dampak">Dampak</a>
                <a class="text-[15px] font-semibold text-on-surface-variant transition-colors hover:text-brand-600" href="#reward">Reward</a>
                <a class="text-[15px] font-semibold text-on-surface-variant transition-colors hover:text-brand-600" href="#mitra">Mitra</a>
            </nav>

            <div class="flex items-center gap-3 sm:gap-5">
                <a class="hidden text-[15px] font-semibold text-on-surface transition-colors hover:text-brand-600 sm:inline" href="{{ route('login') }}">Masuk</a>
        ...
        <div id="mobile-nav" class="hidden border-t border-outline-variant/40 bg-white px-5 py-4 md:hidden">
            <nav class="flex flex-col gap-3 text-sm font-semibold text-on-surface">
    ...
    <footer class="border-t border-outline-variant/40 bg-white">
        <div class="mx-auto flex max-w-7xl flex-col gap-6 px-5 py-10 sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-12">
            <div>
                ...
                <p class="mt-2 max-w-sm text-sm text-on-surface-variant">&copy; {{ date('Y') }} TemJi — Gerakan Kesadaran Sampah Berkelanjutan</p>
            </div>
            <div class="flex flex-wrap gap-5 text-sm font-medium text-on-surface-variant">
