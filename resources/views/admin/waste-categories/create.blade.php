...
@section('title', 'Tambah Kategori - Admin TemJi')
    ...
    <div class="mx-auto max-w-xl">
        ...
        <div class="card">
            <div class="card-header">
                <h1 class="text-lg font-bold text-on-surface">Tambah Kategori Sampah</h1>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.waste-categories.store') }}" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="number" id="points_per_kg" name="points_per_kg" min="1" value="{{ old('points_per_kg') }}" required
